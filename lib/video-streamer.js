...
class VideoStreamer {
    ...
    streamVideo(videoPath) {
        return new Promise((resolve, reject) => {
            ...
            // Start FFmpeg process with deep probing and normalization
            const ffmpeg = spawn('ffmpeg', [
                '-re', // Read input at native frame rate
                '-fflags', '+genpts+igndts', // Better timestamps handling
                '-analyzeduration', '200M', // Deep probing for weird files
                '-probesize', '200M',
                '-i', videoPath,
                // Force normalization
                ...
                '-keyint_min', '60', // Force consistent keyframes
                '-c:a', 'aac',
                '-b:a', '192k',
                '-ac', '2',
                '-ar', '48000',
